# ============================================================================
# Exp I: 更激进类阈值 — Tank 禁用伪标签(1.0), Bridge 高阈值(0.85)
# Round 2 组合实验
# ============================================================================
...
gpu = 1
# Exp I: aggressive per-class thresholds
# ship=0.45, aircraft=0.45, car=0.45, tank=1.0(disabled), bridge=0.85, harbor=0.55
score = [0.45, 0.45, 0.45, 1.0, 0.85, 0.55]
samples_per_gpu = 2
total_epoch = 12
test_interval = 1
save_interval = 1
