# ============================================================================
# Exp J: 全组合 + 阈值退火 — D+E+C + linear annealing
# Round 2 组合实验
# ============================================================================
...
gpu = 1
# Exp J: high initial per-class thresholds (will anneal down)
score = [0.6, 0.6, 0.6, 0.9, 0.8, 0.7]
samples_per_gpu = 2
total_epoch = 12
test_interval = 1
save_interval = 1
...
# Exp J: unlabeled pool = train set (Exp C)
data = dict(
...
model = dict(
    ...
    cfg=dict(
        ...
        max_iters=47304,
        # Exp J: threshold annealing with per-class thresholds
        thr_schedule='linear',
        score_thr_start=0.9,
        score_thr_end=0.5,
    ),
