...
img_prefix_corrupt = data_root + "Corruption/JPEGImages-${corrupt}"
ann_file_train = data_root + "ImageSets/train.txt"
ann_file_val = data_root + "ImageSets/val.txt"
ann_file_test = data_root + "ImageSets/test.txt"

# DIOR xml annotations
