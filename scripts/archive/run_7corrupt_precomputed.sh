...
echo "  5 GPU, pre-computed features (no ViT-L-14 at train time)"
echo "  CGA_PRECOMPUTED_DIR=$CGA_PRECOMPUTED_DIR"
echo "  Start: $(date)"
echo "============================================================"
...
for corrupt in "${CORRUPTS[@]}"; do
    ...
    echo ""
    echo "[$(date +%H:%M:%S)] === $corrupt === (5 GPU, precomputed features)"
