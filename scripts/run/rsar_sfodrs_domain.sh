...
iraod_log_file "${LOG}" "rsar-domain" "config=${CONFIG} work_root=${WORK_ROOT} cuda=${CUDA_VISIBLE_DEVICES:-unset} ngpus=${NGPUS} port=${MASTER_PORT} loader_mode=${RSAR_LOADER_MODE} score_thr=${PSEUDO_SCORE_THR_ARG} corr_aug=${RSAR_CORR_AUG:-0} thr_schedule=${RSAR_THR_SCHEDULE:-none} score_thr_start=${RSAR_SCORE_THR_START:-} score_thr_end=${RSAR_SCORE_THR_END:-}"
