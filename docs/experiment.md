...
| Smoke | [ ] |
| Full | [ ] |
| Logs | running: `.rd_queue_ut_nocga/logs/J20260128-134057-16bf__e0038-smoke-fix-vram16.log`；train: `work_dirs/exp_rsar_ut_nocga_full_fix_vram16_smoke/20260128_214108.log`；queued(full): `.rd_queue_ut_nocga/logs/J20260128-135609-6597__e0038-full-fix-vram16.log`；previous failures: `.rd_queue_ut_nocga/logs/J20260127-171316-356e__e0038-smoke.log` / `.rd_queue_ut_nocga/logs/J20260127-171657-9620__e0038-smoke-rerun.log`（NCCL Error 3）/ `.rd_queue_ut_nocga/logs/J20260128-131634-f635__e0038-smoke-rerun2.log`（CUDA OOM）；full blocked: `.rd_queue_ut_nocga/logs/J20260127-171328-7855__e0038-full.log` / `.rd_queue_ut_nocga/logs/J20260127-171708-c273__e0038-full-rerun.log` |
| Artifacts | `work_dirs/exp_rsar_ut_nocga_full_fix_vram16*/` |
| Results | rerun3（batch=16, GPU7-9）进行中；rerun2 OOM 的 workaround：batch 从 20 降到 16 + `PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:256`（同时避开 GPU4/5 ghost 占用） |
...
| Smoke | [ ] |
| Full | [ ] |
| Logs | queued(smoke/full): `.rd_queue_ut_nocga/logs/J20260128-135450-0433__e0039-smoke-fix-vram14.log` / `.rd_queue_ut_nocga/logs/J20260128-135620-fa74__e0039-full-fix-vram14.log`；previous (terminated): `.rd_queue_ut_cga/logs/J20260128-131644-a0a0__e0039-smoke-rerun2.log`（exit=-15）; train: `work_dirs/exp_rsar_ut_cga_sarclip_full_fix_vram18_smoke/20260128_211654.log`; previous failures: `.rd_queue_ut_cga/logs/J20260127-171357-9a89__e0039-smoke.log` / `.rd_queue_ut_cga/logs/J20260127-171723-1c8e__e0039-smoke-rerun.log`（NCCL Error 3）；full blocked: `.rd_queue_ut_cga/logs/J20260127-171410-a071__e0039-full.log` / `.rd_queue_ut_cga/logs/J20260127-171737-6a00__e0039-full-rerun.log` |
| Artifacts | `work_dirs/exp_rsar_ut_cga_sarclip_full_fix_vram14*/` |
| Results | rerun2 手动停掉（需要先修复默认超参 + teacher/EMA 的 `CLASSES` 传播）；下一次 rerun 将用 vram14（batch=14）重跑 smoke，并检查 CGA init classes 是否为 RSAR 六类 |
