...
| Single-GPU script | `conda run -n dino_sar python tools/check_image_ann_alignment.py --ann-dir dataset/RSAR/train/annfiles --img-dir dataset/RSAR/train/images --out-csv work_dirs/sanity/rsar_alignment_train.csv` |
| Multi-GPU script | `N/A` |
| Smoke cmd | `conda run -n dino_sar python tools/check_image_ann_alignment.py --ann-dir dataset/RSAR/train/annfiles --img-dir dataset/RSAR/train/images --out-csv work_dirs/sanity/rsar_alignment_train.csv` |
| Full cmd | `conda run -n dino_sar python tools/check_image_ann_alignment.py --ann-dir dataset/RSAR/train/annfiles --img-dir dataset/RSAR/train/images --out-csv work_dirs/sanity/rsar_alignment_train.csv` |
| Smoke | [x] |
| Full | [x] |
| Logs | stdout |
...
| Time/epoch | N/A |
| Total time | ~1–5 min |
| Single-GPU script | `conda run -n dino_sar python tools/cache_benchmark.py --scorer clip --image dataset/DIOR/JPEGImages/00001.jpg --prompt "an aerial image of airplane"` |
| Multi-GPU script | `N/A` |
| Smoke cmd | `bash -lc 'conda run -n dino_sar python tools/cache_benchmark.py --scorer clip --image dataset/DIOR/JPEGImages/00001.jpg --prompt "an aerial image of airplane" && conda run -n dino_sar python tools/sarclip_smoke.py --image dataset/RSAR/train/images/0000002.png --prompts "an SAR image of ship"'` |
| Full cmd | `bash -lc 'conda run -n dino_sar python tools/cache_benchmark.py --scorer clip --image dataset/DIOR/JPEGImages/00001.jpg --prompt "an aerial image of airplane" && conda run -n dino_sar python tools/sarclip_smoke.py --image dataset/RSAR/train/images/0000002.png --prompts "an SAR image of ship"'` |
| Smoke | [x] |
| Full | [x] |
...
| Single-GPU script | `bash -lc 'conda run -n dino_sar python tools/verify_rsar_corrupt_switch.py --data-root dataset/RSAR --corrupt interf_jamA && CORRUPT=interf_jamA WORK_DIR=work_dirs/exp_smoke_rsar_interf_jamA VIS_DIR=work_dirs/vis_rsar_interf_jamA bash scripts/smoke_rsar.sh'` |
| Multi-GPU script | `N/A` |
| Smoke cmd | `bash -lc 'conda run -n dino_sar python tools/verify_rsar_corrupt_switch.py --data-root dataset/RSAR --corrupt interf_jamA && CORRUPT=interf_jamA WORK_DIR=work_dirs/exp_smoke_rsar_interf_jamA VIS_DIR=work_dirs/vis_rsar_interf_jamA bash scripts/smoke_rsar.sh'` |
| Full cmd | `bash -lc 'conda run -n dino_sar python tools/verify_rsar_corrupt_switch.py --data-root dataset/RSAR --corrupt interf_jamA && CORRUPT=interf_jamA WORK_DIR=work_dirs/exp_smoke_rsar_interf_jamA VIS_DIR=work_dirs/vis_rsar_interf_jamA bash scripts/smoke_rsar.sh'` |
| Smoke | [x] |
| Full | [x] |
...
| Single-GPU script | `conda run -n dino_sar python tools/vis_random_samples.py --vis-dirs work_dirs/exp_dior_baseline_eval/vis_clean work_dirs/exp_dior_ut/vis_clean work_dirs/exp_dior_ut_cga_clip/vis_clean --num 8 --out-dir work_dirs/results/vis_compare/dior_clean` |
| Multi-GPU script | `N/A` |
| Smoke cmd | `conda run -n dino_sar python tools/vis_random_samples.py --vis-dirs work_dirs/exp_dior_baseline_eval/vis_clean work_dirs/exp_dior_ut/vis_clean --num 4 --out-dir work_dirs/results/vis_compare/dior_clean_smoke` |
| Full cmd | `conda run -n dino_sar python tools/vis_random_samples.py --vis-dirs work_dirs/exp_dior_baseline_eval/vis_clean work_dirs/exp_dior_ut/vis_clean work_dirs/exp_dior_ut_cga_clip/vis_clean --num 16 --out-dir work_dirs/results/vis_compare/dior_clean` |
| Smoke | [x] |
| Full | [x] |
| Logs | stdout |
...
| Single-GPU script | `conda run -n dino_sar python tools/plot_all.py --metrics-csv work_dirs/results/metrics.csv --log-json-glob 'work_dirs/exp_*/*.log.json' --out-dir work_dirs/results/plots` |
| Multi-GPU script | `N/A` |
| Smoke cmd | `conda run -n dino_sar python tools/plot_all.py --metrics-csv work_dirs/results/metrics.csv --out-dir work_dirs/results/plots_smoke` |
| Full cmd | `conda run -n dino_sar python tools/plot_all.py --metrics-csv work_dirs/results/metrics.csv --log-json-glob 'work_dirs/exp_*/*.log.json' --out-dir work_dirs/results/plots` |
| Smoke | [x] |
| Full | [x] |
| Logs | stdout |
...
| Time/epoch | N/A |
| Total time | ~秒级 |
| Single-GPU script | `bash -lc 'conda run -n dino_sar python tools/export_experiments.py --metrics-csv work_dirs/results/metrics.csv --out-csv experiments.csv && test -f README_experiments.md && test -f MODEL_ZOO.md'` |
| Multi-GPU script | `N/A` |
| Smoke cmd | `conda run -n dino_sar python tools/export_experiments.py --metrics-csv work_dirs/results/metrics.csv --out-csv experiments.csv` |
| Full cmd | `bash -lc 'conda run -n dino_sar python tools/export_experiments.py --metrics-csv work_dirs/results/metrics.csv --out-csv experiments.csv && test -f README_experiments.md && test -f MODEL_ZOO.md'` |
| Smoke | [x] |
| Full | [x] |
| Logs | stdout |
