...
- **method-level**: changes code logic (model, loss, algorithm), not just a numeric config value
...
- **standalone hyperparameter tuning** (LR, weight decay, batch size, thresholds, epoch count, schedule) — these are NOT research contributions unless they support a method change
